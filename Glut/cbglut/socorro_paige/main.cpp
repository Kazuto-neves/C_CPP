...
void quadrado(float v1[], float v2[], float v3[], float v4[],double a) {
...
void cubo(float d,double a) {
    ...
    // frontal
    quadrado(v1, v2, v3, v4,a);

    // lateral direita
    quadrado(v4, v3, v6, v5,a);

    // traseiro
    quadrado(v5, v8, v7, v6,a);

    //lateral esquerda
    quadrado(v1, v8, v7, v2,a);

    //topo
    quadrado(v1, v4, v5, v8,a);

    //base
    quadrado(v2, v7, v6, v3,a);
}
